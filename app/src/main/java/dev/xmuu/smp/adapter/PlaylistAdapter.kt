...
import dev.xmuu.smp.databinding.ItemPlaylistCurrentBinding
import dev.xmuu.smp.databinding.ItemPlaylistNormalBinding
...
private const val CURRENT = R.layout.item_playlist_current
private const val NORMAL = R.layout.item_playlist_normal

class PlaylistAdapter(private var context: Context) :
    ...
    override fun getItemViewType(position: Int): Int {
        return if (_list.isEmpty()) {
            ...
            if (_list[position] == App.musicController.value?.getCurrentSong()) {
                CURRENT
            } else {
                NORMAL
            }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when(viewType) {
            CURRENT -> CurrentViewHolder(view)
    ...
    inner class CurrentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val binding: ItemPlaylistCurrentBinding by viewbind()

        fun bindData(song: Song) {
            binding.apply {
                playlistTitle.text = song.name
                playlistSubtitle.text = song.getSubtitle()
    ...
    inner class NormalViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val binding: ItemPlaylistNormalBinding by viewbind()
